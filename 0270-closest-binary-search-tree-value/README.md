<h2><a href="https://leetcode.com/problems/closest-binary-search-tree-value/?envType=problem-list-v2&envId=binary-search">270. Closest Binary Search Tree Value</a></h2><h3>Easy</h3><hr><p>Given the <code>root</code> of a binary search tree and a <code>target</code> value, return <em>the value in the BST that is closest to the</em> <code>target</code>. If there are multiple answers, print the smallest.</p>
